...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "Testa le risposte su set di domande con un giudice indipendente: punteggi di groundedness e correttezza, media e storico per ottimizzare con metriche, non a occhio.",
    tag: null,
  },
] as const;
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl w-full text-center space-y-8 relative z-10 animate-slide-up">
          ...
          <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
            Il laboratorio dove progetti, testi e ottimizzi agenti specializzati.
